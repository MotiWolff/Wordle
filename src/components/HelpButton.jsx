...
function HelpButton() {
  ...
  // Root node for outside-click detection
  ...
  return (
    // Help button with a basic dropdown
    <div className="help-container" ref={dropdownRef}>
      <button
      ...
      {/* Lazy render the dropdown only when open */}
      {isOpen && (
            ...
            <div className="help-examples">
              ...
              <div className="example">
                <div className="example-row">
                  ...
                  <div className="example-tile almost">I</div>
              ...
              <div className="example">
                <div className="example-row">
                  ...
                  <div className="example-tile error">U</div>
                  <div className="example-tile">E</div>
                </div>
                <p>
